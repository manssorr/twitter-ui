...
const Header = () => {
  ...
  return (
    <View style={{ paddingTop: insets.top }} className="w-full bg-white">
      <View className="w-full flex-row items-center justify-center py-3">
        <StyledExpoImage
...
const AddPostButton = () => {
  ...
  return (
    <TouchableOpacity
      className="absolute bottom-6 right-6 z-10 flex 
        h-14 w-14 items-center justify-center rounded-full bg-blue-500 shadow-lg"
      style={{
